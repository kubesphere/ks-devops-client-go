...
// V1alpha3GitlabSource v1alpha3 gitlab source
//
// swagger:model v1alpha3.GitlabSource
type V1alpha3GitlabSource struct {

	// Allow Jenkins send build status notification to Gitlab
...
// Validate validates this v1alpha3 gitlab source
func (m *V1alpha3GitlabSource) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1alpha3GitlabSource) validateDiscoverPrFromForks(formats strfmt.Registry) error {
...
func (m *V1alpha3GitlabSource) validateGitCloneOption(formats strfmt.Registry) error {
...
// ContextValidate validate this v1alpha3 gitlab source based on the context it is used
func (m *V1alpha3GitlabSource) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *V1alpha3GitlabSource) contextValidateDiscoverPrFromForks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha3GitlabSource) contextValidateGitCloneOption(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1alpha3GitlabSource) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1alpha3GitlabSource) UnmarshalBinary(b []byte) error {
	var res V1alpha3GitlabSource
