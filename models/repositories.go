...
type Repositories struct {
	...
	// items
	// Required: true
	Items []*ScmRepository `json:"items"`
}
...
func (m *Repositories) validateItems(formats strfmt.Registry) error {
...
func (m *Repositories) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
