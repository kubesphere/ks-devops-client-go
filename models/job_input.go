...
func (m *JobInput) validateParameters(formats strfmt.Registry) error {
...
func (m *JobInput) contextValidateParameters(ctx context.Context, formats strfmt.Registry) error {
