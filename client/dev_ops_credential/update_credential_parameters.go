...
func (o *UpdateCredentialParams) WithBody(body *models.V1Secret) *UpdateCredentialParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update credential params
func (o *UpdateCredentialParams) SetBody(body *models.V1Secret) {
	o.Body = body
}

// WithCredential adds the credential to the update credential params
func (o *UpdateCredentialParams) WithCredential(credential string) *UpdateCredentialParams {
	o.SetCredential(credential)
	return o
}

// SetCredential adds the credential to the update credential params
func (o *UpdateCredentialParams) SetCredential(credential string) {
	o.Credential = credential
}

// WithDevops adds the devops to the update credential params
func (o *UpdateCredentialParams) WithDevops(devops string) *UpdateCredentialParams {
	o.SetDevops(devops)
	return o
}

// SetDevops adds the devops to the update credential params
func (o *UpdateCredentialParams) SetDevops(devops string) {
	o.Devops = devops
}
