...
func (o *GetConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /kapis/devops.kubesphere.io/v1alpha3/namespaces/{namespace}/gitrepositories/{gitrepository}/configs/default] GetConfig", response, response.Code())
	}
}
...
type GetConfigOK struct {
	Payload *models.GitopsGetConfigOutput
}
...
func (o *GetConfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /kapis/devops.kubesphere.io/v1alpha3/namespaces/{namespace}/gitrepositories/{gitrepository}/configs/default][%d] getConfigOK %s", 200, payload)
}
