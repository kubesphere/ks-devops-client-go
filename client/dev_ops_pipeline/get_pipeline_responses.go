...
func (o *GetPipelineReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /kapis/devops.kubesphere.io/v1alpha2/namespaces/{devops}/pipelines/{pipeline}] GetPipeline", response, response.Code())
	}
}
...
func (o *GetPipelineOK) Error() string {
	...
	return fmt.Sprintf("[GET /kapis/devops.kubesphere.io/v1alpha2/namespaces/{devops}/pipelines/{pipeline}][%d] getPipelineOK %s", 200, payload)
}
...
func (o *GetPipelineOK) GetPayload() *models.DevopsPipeline {
	return o.Payload
}
...
func (o *GetPipelineOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DevopsPipeline)
