...
type GetBranchParams struct {
	...
	/* Branch.
	   ...
	   Name of branch, tag or pull request
	*/
	Branch string
...
// WithPipeline adds the pipeline to the get branch params
func (o *GetBranchParams) WithPipeline(pipeline string) *GetBranchParams {
	o.SetPipeline(pipeline)
	return o
}

// SetPipeline adds the pipeline to the get branch params
func (o *GetBranchParams) SetPipeline(pipeline string) {
	o.Pipeline = pipeline
}
