...
func (o *ValidateParams) WithBody(body []int64) *ValidateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the validate params
func (o *ValidateParams) SetBody(body []int64) {
	o.Body = body
}

// WithScm adds the scm to the validate params
func (o *ValidateParams) WithScm(scm string) *ValidateParams {
	o.SetScm(scm)
	return o
}

// SetScm adds the scm to the validate params
func (o *ValidateParams) SetScm(scm string) {
	o.Scm = scm
}
