...
func (o *VerifyParams) WithBody(body []int64) *VerifyParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the verify params
func (o *VerifyParams) SetBody(body []int64) {
	o.Body = body
}

// WithScm adds the scm to the verify params
func (o *VerifyParams) WithScm(scm string) *VerifyParams {
	o.SetScm(scm)
	return o
}

// SetScm adds the scm to the verify params
func (o *VerifyParams) SetScm(scm string) {
	o.Scm = scm
}

// WithSecret adds the secret to the verify params
func (o *VerifyParams) WithSecret(secret string) *VerifyParams {
	o.SetSecret(secret)
	return o
}

// SetSecret adds the secret to the verify params
func (o *VerifyParams) SetSecret(secret string) {
	o.Secret = secret
}

// WithSecretNamespace adds the secretNamespace to the verify params
func (o *VerifyParams) WithSecretNamespace(secretNamespace string) *VerifyParams {
	o.SetSecretNamespace(secretNamespace)
	return o
}

// SetSecretNamespace adds the secretNamespace to the verify params
func (o *VerifyParams) SetSecretNamespace(secretNamespace string) {
	o.SecretNamespace = secretNamespace
}

// WithServer adds the server to the verify params
func (o *VerifyParams) WithServer(server *string) *VerifyParams {
	o.SetServer(server)
	return o
}

// SetServer adds the server to the verify params
func (o *VerifyParams) SetServer(server *string) {
	o.Server = server
}
